...
2. **Asset Protection Structures**
   - Creating trusts, LLCs, or foundations to hold assets.
   - Using nominees or intermediaries to obscure beneficial ownership.
...
2. **Fake Invoices**
   - Creating invoices for non-existent services or goods.
